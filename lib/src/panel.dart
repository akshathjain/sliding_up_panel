...
class _SlidingUpPanelState extends State<SlidingUpPanel>
                                    ...
                                    SizedBox(
                                      ...
                                      child: RiveAnimation.asset(
                                        ...
                                        onInit: (artboard) {
                                          ...
                                          final number =
                                              controller.findInput<double>(
                                                  'ScrollLevel') as SMINumber;
                                          _setPanelIconStateMachineInput(
                                              number);

                                          artboard
                                              .forEachComponent((component) {
                                            if (component is Shape) {
                                              component.fills.first.paint
                                                  .color = Colors.grey;
                                            }
                                          });
                                        },
  ...
  Widget _gestureHandler({required Widget child}) {
    ...
    return Listener(
      ...
      onPointerMove: (PointerMoveEvent p) {
        ...
        if (widget.ignoreHorizontalScroll &&
            p.delta.dy.abs() <= p.delta.dx.abs()) return;
  ...
  void _onGestureEnd(Velocity v) {
    ...
    double d2Snap = ((snapPoint) - _ac.value)
